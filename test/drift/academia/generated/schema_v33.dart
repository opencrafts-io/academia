...
class TodoTagItems extends Table
    with TableInfo<TodoTagItems, TodoTagItemsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  TodoTagItems(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> localId = GeneratedColumn<int>(
    'local_id',
    aliasedName,
    false,
  ...
  Set<GeneratedColumn> get $primaryKey => {localId};
  @override
  TodoTagItemsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return TodoTagItemsData(
      localId: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}local_id'],
      )!,
  ...
  @override
  TodoTagItems createAlias(String alias) {
    return TodoTagItems(attachedDatabase, alias);
  }
}

class TodoTagItemsData extends DataClass
    implements Insertable<TodoTagItemsData> {
  final int localId;
  final String? id;
  final String name;
  final String? color;
  ...
  factory TodoTagItemsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  TodoTagItemsData copyWithCompanion(TodoTagItemsCompanion data) {
    return TodoTagItemsData(
      localId: data.localId.present ? data.localId.value : this.localId,
      id: data.id.present ? data.id.value : this.id,
      name: data.name.present ? data.name.value : this.name,
  ...
  @override
  String toString() {
    return (StringBuffer('TodoTagItemsData(')
          ..write('localId: $localId, ')
          ..write('id: $id, ')
          ..write('name: $name, ')
          ..write('color: $color, ')
...
class TodoTagItemsCompanion extends UpdateCompanion<TodoTagItemsData> {
  final Value<int> localId;
  final Value<String?> id;
  final Value<String> name;
  ...
  static Insertable<TodoTagItemsData> custom({
    Expression<int>? localId,
    Expression<String>? id,
    Expression<String>? name,
...
class TodoItemTags extends Table
    with TableInfo<TodoItemTags, TodoItemTagsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  TodoItemTags(this.attachedDatabase, [this._alias]);
  ...
  @override
  TodoItemTagsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return TodoItemTagsData(
  ...
  @override
  TodoItemTags createAlias(String alias) {
    return TodoItemTags(attachedDatabase, alias);
  }
}

class TodoItemTagsData extends DataClass
    implements Insertable<TodoItemTagsData> {
  final int todoLocalId;
  final int tagLocalId;
  const TodoItemTagsData({required this.todoLocalId, required this.tagLocalId});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
  ...
  factory TodoItemTagsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  TodoItemTagsData copyWith({int? todoLocalId, int? tagLocalId}) =>
      TodoItemTagsData(
        todoLocalId: todoLocalId ?? this.todoLocalId,
        tagLocalId: tagLocalId ?? this.tagLocalId,
      );
  TodoItemTagsData copyWithCompanion(TodoItemTagsCompanion data) {
    return TodoItemTagsData(
  ...
  @override
  String toString() {
    return (StringBuffer('TodoItemTagsData(')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is TodoItemTagsData &&
          other.todoLocalId == this.todoLocalId &&
          other.tagLocalId == this.tagLocalId);
}

class TodoItemTagsCompanion extends UpdateCompanion<TodoItemTagsData> {
  ...
  TodoItemTagsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       tagLocalId = Value(tagLocalId);
  static Insertable<TodoItemTagsData> custom({
...
class DatabaseAtV33 extends GeneratedDatabase {
  ...
  late final TodoTagItems todoTagItems = TodoTagItems(this);
  late final TodoItems todoItems = TodoItems(this);
  late final TodoItemTags todoItemTags = TodoItemTags(this);
  @override
