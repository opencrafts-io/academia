...
class InstitutionCourseTimetableEntry extends Table
  ...
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  InstitutionCourseTimetableEntry(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
    aliasedName,
    false,
  ...
  @override
  InstitutionCourseTimetableEntry createAlias(String alias) {
    return InstitutionCourseTimetableEntry(attachedDatabase, alias);
  }
}
...
class DatabaseAtV23 extends GeneratedDatabase {
  ...
  late final InstitutionCourseTimetableEntry institutionCourseTimetableEntry =
      InstitutionCourseTimetableEntry(this);
