...
class Token extends Table with TableInfo<Token, TokenData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  Token(this.attachedDatabase, [this._alias]);
  ...
  @override
  Token createAlias(String alias) {
    return Token(attachedDatabase, alias);
  }
}
...
class TicketTable extends Table with TableInfo<TicketTable, TicketTableData> {
  ...
  late final GeneratedColumn<String> ticketVisibility = GeneratedColumn<String>(
    'ticket_visibility',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  TicketTableData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return TicketTableData(
      ...
      ticketVisibility: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
...
class TicketTableData extends DataClass implements Insertable<TicketTableData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || ticketVisibility != null) {
      map['ticket_visibility'] = Variable<String>(ticketVisibility);
    }
  ...
  factory TicketTableData.fromJson(
    ...
    return TicketTableData(
      ...
      ticketQuantity: serializer.fromJson<int?>(json['ticketQuantity']),
      ticketVisibility: serializer.fromJson<String?>(json['ticketVisibility']),
      deleteTag: serializer.fromJson<bool?>(json['deleteTag']),
      createdAt: serializer.fromJson<String?>(json['createdAt']),
      updatedAt: serializer.fromJson<String?>(json['updatedAt']),
    );
  }
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'ticketQuantity': serializer.toJson<int?>(ticketQuantity),
      'ticketVisibility': serializer.toJson<String?>(ticketVisibility),
      'deleteTag': serializer.toJson<bool?>(deleteTag),
      'createdAt': serializer.toJson<String?>(createdAt),
      'updatedAt': serializer.toJson<String?>(updatedAt),
    };
  }
  ...
  TicketTableData copyWith({
    ...
    Value<String?> ticketVisibility = const Value.absent(),
...
class TicketTableCompanion extends UpdateCompanion<TicketTableData> {
  ...
  final Value<int?> ticketQuantity;
  final Value<String?> ticketVisibility;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (ticketVisibility.present) {
      map['ticket_visibility'] = Variable<String>(ticketVisibility.value);
    }
...
class DatabaseAtV25 extends GeneratedDatabase {
  ...
  late final Token token = Token(this);
