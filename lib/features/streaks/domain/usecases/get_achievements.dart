...
class GetAchievements implements UseCase<PaginatedAchievements, GetAchievementsParams> {
  final AchievementRepository repository;

  GetAchievements(this.repository);

  @override
  Future<Either<Failure, PaginatedAchievements>> call(GetAchievementsParams params) async {
