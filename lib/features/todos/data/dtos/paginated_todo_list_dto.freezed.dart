...
String toString() {
  final _this = this as PaginatedTodoListDto;
  return 'PaginatedTodoListDto(count: ${_this.count}, next: ${_this.next}, previous: ${_this.previous}, results: ${_this.results})';
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? count = null,Object? next = freezed,Object? previous = freezed,Object? results = null,}) {
  return _then(PaginatedTodoListDto(
...
class _PaginatedTodoListDto implements PaginatedTodoListDto {
  const _PaginatedTodoListDto({required this.count, required this.next, required this.previous, required  List<TodoListDto> results}): _results = results;
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _PaginatedTodoListDto&&(identical(other.count, count) || other.count == count)&&(identical(other.next, next) || other.next == next)&&(identical(other.previous, previous) || other.previous == previous)&&const DeepCollectionEquality().equals(other.results, _results));
}
