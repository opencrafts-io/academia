...
bool operator ==(Object other) {
  final _this = this as TodoTagDto;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TodoTagDto&&(identical(other.id, _this.id) || other.id == _this.id)&&(identical(other.name, _this.name) || other.name == _this.name)&&(identical(other.color, _this.color) || other.color == _this.color)&&(identical(other.createdAt, _this.createdAt) || other.createdAt == _this.createdAt));
}
...
int get hashCode {
  final _this = this as TodoTagDto;
  return Object.hash(runtimeType,_this.id,_this.name,_this.color,_this.createdAt);
}

@override
String toString() {
  final _this = this as TodoTagDto;
  return 'TodoTagDto(id: ${_this.id}, name: ${_this.name}, color: ${_this.color}, createdAt: ${_this.createdAt})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,id,name,color,createdAt);
}
