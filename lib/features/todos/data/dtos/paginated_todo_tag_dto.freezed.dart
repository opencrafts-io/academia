...
String toString() {
  final _this = this as PaginatedTodoTagDto;
  return 'PaginatedTodoTagDto(count: ${_this.count}, next: ${_this.next}, previous: ${_this.previous}, results: ${_this.results})';
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? count = null,Object? next = freezed,Object? previous = freezed,Object? results = null,}) {
  return _then(PaginatedTodoTagDto(
...
class _PaginatedTodoTagDto implements PaginatedTodoTagDto {
  const _PaginatedTodoTagDto({required this.count, required this.next, required this.previous, required  List<TodoTagDto> results}): _results = results;
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _PaginatedTodoTagDto&&(identical(other.count, count) || other.count == count)&&(identical(other.next, next) || other.next == next)&&(identical(other.previous, previous) || other.previous == previous)&&const DeepCollectionEquality().equals(other.results, _results));
}
