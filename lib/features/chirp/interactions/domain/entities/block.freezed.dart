...
int get hashCode {
  final _this = this as Block;
  return Object.hash(runtimeType,_this.id,_this.blockType,_this.blockedId,_this.blockedName,_this.blockedImage,_this.createdAt);
}

@override
String toString() {
  final _this = this as Block;
  return 'Block(id: ${_this.id}, blockType: ${_this.blockType}, blockedId: ${_this.blockedId}, blockedName: ${_this.blockedName}, blockedImage: ${_this.blockedImage}, createdAt: ${_this.createdAt})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,id,blockType,blockedId,blockedName,blockedImage,createdAt);
}
