...
mixin _$PaginatedResponse {
 ...
 int get count; String? get next; String? get previous; List<CommunityUser> get users;
...
bool operator ==(Object other) {
  final _this = this as PaginatedResponse;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PaginatedResponse&&(identical(other.count, _this.count) || other.count == _this.count)&&(identical(other.next, _this.next) || other.next == _this.next)&&(identical(other.previous, _this.previous) || other.previous == _this.previous)&&const DeepCollectionEquality().equals(other.users, _this.users));
}
...
int get hashCode {
  final _this = this as PaginatedResponse;
  return Object.hash(runtimeType,_this.count,_this.next,_this.previous,const DeepCollectionEquality().hash(_this.users));
}

@override
String toString() {
  final _this = this as PaginatedResponse;
  return 'PaginatedResponse(count: ${_this.count}, next: ${_this.next}, previous: ${_this.previous}, users: ${_this.users})';
}
...
@useResult
$Res call({
 int count, String? next, String? previous, List<CommunityUser> users
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int count,  String? next,  String? previous,  List<CommunityUser> users)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PaginatedResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int count,  String? next,  String? previous,  List<CommunityUser> users)  $default,) {final _that = this;
switch (_that) {
case _PaginatedResponse():
return $default(_that.count,_that.next,_that.previous,_that.users);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int count,  String? next,  String? previous,  List<CommunityUser> users)?  $default,) {final _that = this;
switch (_that) {
case _PaginatedResponse() when $default != null:
return $default(_that.count,_that.next,_that.previous,_that.users);case _:
  return null;
...
class _PaginatedResponse implements PaginatedResponse {
  const _PaginatedResponse({required this.count, this.next, this.previous, required  List<CommunityUser> users}): _users = users;
...
@override List<CommunityUser> get users {
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _PaginatedResponse&&(identical(other.count, count) || other.count == count)&&(identical(other.next, next) || other.next == next)&&(identical(other.previous, previous) || other.previous == previous)&&const DeepCollectionEquality().equals(other.users, _users));
}


@override
int get hashCode {
    return Object.hash(runtimeType,count,next,previous,const DeepCollectionEquality().hash(_users));
}

@override
String toString() {
    return 'PaginatedResponse(count: $count, next: $next, previous: $previous, users: $users)';
}
