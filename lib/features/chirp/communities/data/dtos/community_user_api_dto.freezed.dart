...
bool operator ==(Object other) {
  final _this = this as CommunityUserApiDto;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CommunityUserApiDto&&(identical(other.userId, _this.userId) || other.userId == _this.userId)&&(identical(other.userName, _this.userName) || other.userName == _this.userName)&&(identical(other.role, _this.role) || other.role == _this.role));
}
...
String toString() {
  final _this = this as CommunityUserApiDto;
  return 'CommunityUserApiDto(userId: ${_this.userId}, userName: ${_this.userName}, role: ${_this.role})';
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? userId = null,Object? userName = null,Object? role = null,}) {
  return _then(CommunityUserApiDto(
