...
bool operator ==(Object other) {
  final _this = this as CommunityApiDto;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CommunityApiDto&&(identical(other.id, _this.id) || other.id == _this.id)&&(identical(other.name, _this.name) || other.name == _this.name)&&(identical(other.description, _this.description) || other.description == _this.description)&&(identical(other.nsfw, _this.nsfw) || other.nsfw == _this.nsfw)&&(identical(other.private, _this.private) || other.private == _this.private)&&(identical(other.verified, _this.verified) || other.verified == _this.verified)&&(identical(other.visibility, _this.visibility) || other.visibility == _this.visibility)&&(identical(other.memberCount, _this.memberCount) || other.memberCount == _this.memberCount)&&(identical(other.moderatorCount, _this.moderatorCount) || other.moderatorCount == _this.moderatorCount)&&(identical(other.bannedUsersCount, _this.bannedUsersCount) || other.bannedUsersCount == _this.bannedUsersCount)&&(identical(other.monthlyVisitorCount, _this.monthlyVisitorCount) || other.monthlyVisitorCount == _this.monthlyVisitorCount)&&(identical(other.weeklyVisitorCount, _this.weeklyVisitorCount) || other.weeklyVisitorCount == _this.weeklyVisitorCount)&&(identical(other.banner, _this.banner) || other.banner == _this.banner)&&(identical(other.bannerHeight, _this.bannerHeight) || other.bannerHeight == _this.bannerHeight)&&(identical(other.bannerWidth, _this.bannerWidth) || other.bannerWidth == _this.bannerWidth)&&(identical(other.bannerUrl, _this.bannerUrl) || other.bannerUrl == _this.bannerUrl)&&(identical(other.profilePicture, _this.profilePicture) || other.profilePicture == _this.profilePicture)&&(identical(other.profilePictureHeight, _this.profilePictureHeight) || other.profilePictureHeight == _this.profilePictureHeight)&&(identical(other.profilePictureWidth, _this.profilePictureWidth) || other.profilePictureWidth == _this.profilePictureWidth)&&(identical(other.profilePictureUrl, _this.profilePictureUrl) || other.profilePictureUrl == _this.profilePictureUrl)&&(identical(other.creatorId, _this.creatorId) || other.creatorId == _this.creatorId)&&const DeepCollectionEquality().equals(other.guidelines, _this.guidelines)&&(identical(other.createdAt, _this.createdAt) || other.createdAt == _this.createdAt)&&(identical(other.updatedAt, _this.updatedAt) || other.updatedAt == _this.updatedAt));
}
...
int get hashCode {
  final _this = this as CommunityApiDto;
  return Object.hashAll([runtimeType,_this.id,_this.name,_this.description,_this.nsfw,_this.private,_this.verified,_this.visibility,_this.memberCount,_this.moderatorCount,_this.bannedUsersCount,_this.monthlyVisitorCount,_this.weeklyVisitorCount,_this.banner,_this.bannerHeight,_this.bannerWidth,_this.bannerUrl,_this.profilePicture,_this.profilePictureHeight,_this.profilePictureWidth,_this.profilePictureUrl,_this.creatorId,const DeepCollectionEquality().hash(_this.guidelines),_this.createdAt,_this.updatedAt]);
}

@override
String toString() {
  final _this = this as CommunityApiDto;
  return 'CommunityApiDto(id: ${_this.id}, name: ${_this.name}, description: ${_this.description}, nsfw: ${_this.nsfw}, private: ${_this.private}, verified: ${_this.verified}, visibility: ${_this.visibility}, memberCount: ${_this.memberCount}, moderatorCount: ${_this.moderatorCount}, bannedUsersCount: ${_this.bannedUsersCount}, monthlyVisitorCount: ${_this.monthlyVisitorCount}, weeklyVisitorCount: ${_this.weeklyVisitorCount}, banner: ${_this.banner}, bannerHeight: ${_this.bannerHeight}, bannerWidth: ${_this.bannerWidth}, bannerUrl: ${_this.bannerUrl}, profilePicture: ${_this.profilePicture}, profilePictureHeight: ${_this.profilePictureHeight}, profilePictureWidth: ${_this.profilePictureWidth}, profilePictureUrl: ${_this.profilePictureUrl}, creatorId: ${_this.creatorId}, guidelines: ${_this.guidelines}, createdAt: ${_this.createdAt}, updatedAt: ${_this.updatedAt})';
}
...
class _CommunityApiDto implements CommunityApiDto {
  const _CommunityApiDto({required this.id, required this.name, this.description, this.nsfw = false, this.private = false, this.verified = false, required this.visibility, @JsonKey(name: 'member_count') this.memberCount = 0, @JsonKey(name: 'moderator_count') this.moderatorCount = 0, @JsonKey(name: 'banned_users_count') this.bannedUsersCount = 0, @JsonKey(name: 'monthly_visitor_count') this.monthlyVisitorCount = 0, @JsonKey(name: 'weekly_visitor_count') this.weeklyVisitorCount = 0, this.banner, @JsonKey(name: 'banner_height') this.bannerHeight = 0, @JsonKey(name: 'banner_width') this.bannerWidth = 0, @JsonKey(name: 'banner_url') this.bannerUrl, @JsonKey(name: 'profile_picture') this.profilePicture, @JsonKey(name: 'profile_picture_height') this.profilePictureHeight = 0, @JsonKey(name: 'profile_picture_width') this.profilePictureWidth = 0, @JsonKey(name: 'profile_picture_url') this.profilePictureUrl, @JsonKey(name: 'creator_id') required this.creatorId,  List<String> guidelines = const [], @JsonKey(name: 'created_at') required this.createdAt, @JsonKey(name: 'updated_at') required this.updatedAt}): _guidelines = guidelines;
