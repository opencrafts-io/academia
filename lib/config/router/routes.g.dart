    ...
    GoRouteData.$route(
      ...
      routes: [
        ...
        GoRouteData.$route(
          ...
          factory: _$OrganizerDashboardRoute._fromState,
          routes: [
            GoRouteData.$route(
              path: 'all-attendees',
            ...
            GoRouteData.$route(
              ...
              factory: _$AddEventScannerRoute._fromState,
            ),
          ],
        ),
      ],
...
mixin _$OrganizerDashboardRoute on GoRouteData {
...
mixin _$AllAttendeesRoute on GoRouteData {
...
mixin _$AddEventScannerRoute on GoRouteData {
