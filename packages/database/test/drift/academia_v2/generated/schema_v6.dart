...
class Courses extends Table with TableInfo<Courses, CoursesData> {
  ...
  late final GeneratedColumn<int> termStartDate = GeneratedColumn<int>(
    'term_start_date',
    aliasedName,
    true,
    type: DriftSqlType.int,
  ...
  late final GeneratedColumn<int> termEndDate = GeneratedColumn<int>(
    'term_end_date',
    aliasedName,
    true,
    type: DriftSqlType.int,
...
class CoursesData extends DataClass implements Insertable<CoursesData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || termStartDate != null) {
      map['term_start_date'] = Variable<int>(termStartDate);
    }
    if (!nullToAbsent || termEndDate != null) {
      map['term_end_date'] = Variable<int>(termEndDate);
    }
  ...
  factory CoursesData.fromJson(
    ...
    return CoursesData(
      ...
      termStartDate: serializer.fromJson<int?>(json['termStartDate']),
      termEndDate: serializer.fromJson<int?>(json['termEndDate']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'termStartDate': serializer.toJson<int?>(termStartDate),
      'termEndDate': serializer.toJson<int?>(termEndDate),
  ...
  CoursesData copyWith({
    ...
    Value<int?> termStartDate = const Value.absent(),
    Value<int?> termEndDate = const Value.absent(),
...
class CoursesCompanion extends UpdateCompanion<CoursesData> {
  ...
  final Value<int?> termStartDate;
  final Value<int?> termEndDate;
  ...
  static Insertable<CoursesData> custom({
    ...
    Expression<int>? termStartDate,
    Expression<int>? termEndDate,
  ...
  CoursesCompanion copyWith({
    ...
    Value<int?>? termStartDate,
    Value<int?>? termEndDate,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (termStartDate.present) {
      map['term_start_date'] = Variable<int>(termStartDate.value);
    }
    if (termEndDate.present) {
      map['term_end_date'] = Variable<int>(termEndDate.value);
    }
...
class Lecturers extends Table with TableInfo<Lecturers, LecturersData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  Lecturers(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  LecturersData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  Lecturers createAlias(String alias) {
    return Lecturers(attachedDatabase, alias);
  }
...
class LecturersData extends DataClass implements Insertable<LecturersData> {
  final String id;
  ...
  factory LecturersData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  LecturersData copyWithCompanion(LecturersCompanion data) {
    return LecturersData(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('LecturersData(')
          ..write('id: $id, ')
...
class LecturersCompanion extends UpdateCompanion<LecturersData> {
  final Value<String> id;
  ...
  LecturersCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       studentCourseId = Value(studentCourseId),
       name = Value(name);
  static Insertable<LecturersData> custom({
    Expression<String>? id,
...
class DatabaseAtV6 extends GeneratedDatabase {
  ...
  late final Lecturers lecturers = Lecturers(this);
  @override
